...
struct gengetopt_args_info
{
  ...
  char * target_arg;	/**< @brief target name.  */
  char * target_orig;	/**< @brief target name original value given at command line.  */
  const char *target_help; /**< @brief target name help description.  */
  char * output_path_arg;	/**< @brief path to output files.  */
  char * output_path_orig;	/**< @brief path to output files original value given at command line.  */
  const char *output_path_help; /**< @brief path to output files help description.  */
  char * tags_arg;	/**< @brief tags, comma separated, no spaces.  */
